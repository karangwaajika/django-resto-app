...
import SmoothiesTable from "../../components/waiter/SmoothiesTable";
...
function Smoothies() {
  ...
  return (
    <section className="menu">
      <aside className="item-picture smoothies">
        <i style={{ color: "white" }}>Smoothies List</i>
      </aside>
